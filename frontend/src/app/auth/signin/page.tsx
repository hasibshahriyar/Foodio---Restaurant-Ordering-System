    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        <div className="flex items-center justify-center px-1 h-[36px] rounded-[16px] mb-5" style={{ background: '#F2EFE9' }}>
          ...
          <Link href="/auth/register" className="flex items-center justify-center flex-1 h-[29px] rounded-[12px]" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 500, fontSize: 14, color: '#1A1A1A', textAlign: 'center' }}>
            Register
          </Link>
        </div>
